...
const COPY: Record<PopupLanguage, Copy> = {
  en: {
    ...
    resolved: "Resolved",
    collect: "Collect B50",
    includeFullRecords: "Include Full Records (Beta)",
    includeFullRecordsHint: "Adds five DX NET requests for completion and progress tools.",
  ...
  "zh-Hant": {
    ...
    resolved: "已解析",
    collect: "抓取 B50",
    includeFullRecords: "包含完整成績（Beta）",
    includeFullRecordsHint: "額外讀取五個 DX NET 頁面，供完成表與進度工具使用。",
    studio: "在網頁預覽並調整",
    directExport: "直接匯出",
  ...
  ja: {
    ...
    resolved: "解析済み",
    collect: "B50 を取得",
    includeFullRecords: "全成績を含める（Beta）",
    includeFullRecordsHint: "DX NET の 5 ページを追加取得し、達成表と進捗機能で使用します。",
