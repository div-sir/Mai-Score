...
export default function ChartDetail({ record, records, history, language, initiallyOpen = false }: {
  ...
  const copy = language === "zh-Hant"
    ? { details: "單曲詳情", charts: "已收集的各難度", history: "最佳成績觀測歷史", empty: "尚無此譜面的已儲存觀測記錄；不代表未曾遊玩。", target: "目標達成率／單譜 Rating", version: "收錄版本", constant: "譜面定數" }
    : language === "ja"
      ? { details: "楽曲詳細", charts: "取得済みの難易度", history: "ベストスコア観測履歴", empty: "この譜面の保存済み観測記録はありません。未プレイを意味しません。", target: "目標達成率／譜面 Rating", version: "収録バージョン", constant: "譜面定数" }
      : { details: "Song details", charts: "Collected difficulties", history: "Observed best history", empty: "No saved observation for this chart. This does not mean it was unplayed.", target: "Target achievement / chart Rating", version: "Game version", constant: "Chart constant" };
