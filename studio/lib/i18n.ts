...
const COPY: Record<LanguageId, StudioCopy> = {
  en: {
    ...
    clearLocalData: "Clear local scores and history",
    clearConfirm: "Remove the saved scores, images, and all local history from this browser?",
    privacy: "Score data stays in this browser by default. Optional Drive sync stores history in your own Google account.",
    ...
    fullHistorySince: "Full Records tracking since",
    allTime: "All time",
    last30Days: "30d",
    ...
    localDataCleared: "Saved scores, images, and local history were removed from this browser.",
  ...
  "zh-Hant": {
    ...
    processing: "處理中…",
    copyStyle: "複製目前樣式連結",
    clearLocalData: "清除本機成績與歷史紀錄",
    clearConfirm: "要從此瀏覽器移除已儲存的成績、圖片與所有本機歷史紀錄嗎？",
    privacy: "成績資料預設只留在此瀏覽器；啟用同步後，歷史紀錄會存入你自己的 Google 帳號。",
    privacyLink: "隱私權政策",
    share: "分享圖片",
    shared: "已分享。",
    history: "歷史紀錄",
    ...
    localDataCleared: "已從此瀏覽器清除成績、圖片與本機歷史紀錄。",
  ...
  ja: {
    ...
    clearLocalData: "ローカルスコアと履歴を消去",
    clearConfirm: "このブラウザに保存したスコア、画像、すべてのローカル履歴を削除しますか？",
    privacy: "スコアデータは通常このブラウザ内に保存されます。同期を有効にすると、履歴は自分の Google アカウントに保存されます。",
    ...
    localDataCleared: "このブラウザからスコア、画像、ローカル履歴を削除しました。",
